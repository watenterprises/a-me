                        ...
                        <div className="space-y-12">
                                ...
                                <FadeIn delay={0.1}>
                                    ...
                                    <ul className="space-y-6">
                                        <li className="flex gap-4 items-start">
                                            ...
                                            <span className="text-stone-600 text-sm leading-loose">No.245, 3rd Floor, HMT Layout,<br />Nellagadranahalli, Bengaluru – 560073</span>
                                        </li>
                                        <li className="flex gap-4 items-start">
                                        ...
                                        <li className="flex gap-4 items-center">
                                            <Instagram className="w-6 h-6 text-charcoal-900" />
                                            <a href="https://www.instagram.com/aplusme.in/" target="_blank" rel="noopener noreferrer" className="text-stone-600 text-sm hover:text-charcoal-900 transition-colors">
                                                @aplusme.in
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <FadeIn delay={0.2} className="w-full">
                                <div className="h-[400px] w-full bg-stone-100 relative grayscale rounded-sm overflow-hidden">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4003.4364132512537!2d77.50061107515377!3d13.033887513509463!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3dd489581821%3A0xbaa5caff7f389b35!2sa%2Bme%20Architects!5e0!3m2!1sen!2sin!4v1771235770931!5m2!1sen!2sin"
                                        width="100%"
                                        height="100%"
                                        style={{ border: 0 }}
                        ...
                        <div className="bg-stone-50 p-8 md:p-12 rounded-sm">
                            <FadeIn delay={0.3}>
                                ...
                                <form className="space-y-6" onSubmit={handleSubmit}>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-sm font-bold text-stone-500">Email</label>
                                        <input
                                            type="email"
                                            id="email"
                                            required
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="message" className="text-sm font-bold text-stone-500">Message</label>
                                        <textarea
                                            id="message"
                                            required
                                            rows={6}
